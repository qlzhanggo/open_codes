...
#integrate.trapezoid test
from scipy import integrate
mask=np.zeros_like(fe.vp12)
mask[(fe.vp12>fe.param['vte']*10)]=1
j_re= integrate.trapezoid(integrate.trapezoid(fe.dist*fe.vp12**2*np.sqrt(1-1/(fe.vp12**2+1))*fe.xip12[:,None]*mask,fe.vp12),fe.xip12)*2*np.pi
print('j_re from integrate.trapezoid ',j_re)
